...
def mock_success_response():
    ...
    return mock_responses.create_mock_success_response()


@pytest.fixture
def mock_not_found_response():
    """Fixture for a 404 Not Found HTTP response."""
    return mock_responses.create_mock_not_found_response()


@pytest.fixture
def mock_forbidden_response():
    """Fixture for a 403 Forbidden HTTP response."""
    return mock_responses.create_mock_forbidden_response()


@pytest.fixture
def mock_bad_request_response():
    """Fixture for a 400 Bad Request HTTP response."""
    return mock_responses.create_mock_bad_request_response()
...
@pytest.fixture
def mock_success_get_pipeline():
    """Fixture for a successful GET pipeline response."""
    return mock_responses.create_mock_success_get_pipeline()
