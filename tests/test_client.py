...
def test_client_get_pipeline_success(valid_pipeline_config, mock_success_response):
...
def test_client_get_pipeline_not_found(mock_not_found_response):
...
def test_client_list_pipelines_success_list_format():
...
def test_client_list_pipeline_success_single_format():
...
def test_client_list_pipelines_empty():
...
def test_client_create_pipeline_success(valid_pipeline_config, mock_success_response):
...
def test_client_delete_pipeline_not_found(mock_not_found_response):
